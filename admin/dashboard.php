...
// Query untuk menghitung jumlah penyewaan (DIPERBAIKI)
// Kita JOIN dengan tabel 'jadwal' dan filter berdasarkan 'waktuMulai'
...
// Query untuk menghitung total pemasukan (DIPERBAIKI)
// Kita JOIN dengan tabel 'jadwal' dan filter berdasarkan 'waktuMulai'
...
{
    // ... (Fungsi buatKalender Anda sudah benar, tidak perlu diubah) ...
